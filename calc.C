{
  //cout<< 1.2*157 + 120 + 125.0/2 + 91 + 30 + 0.35*265.0 + 534.0/8 + 207*1.8/5<<endl;
  //cout<< 1.2*157 + 125.0/2 + 91 + 30 + 0.35*265.0 + 534.0/8<<endl;
  //29.11.2020
  /*cout<<5.00/9.0*2.0*201<<" + " //HLEB
      <<1.80/10 * 202<<" + "      //NAMAZKA
      <<53<<" + "                 //shokolad
      <<300<<" + "                //sup
      <<1.0/2.0*325               //Gorgonzolla
      <<endl;
  cout<<0.75*325<<" + " //ris
      <<0.12*661<<" + " //maslo slivochnoe
      <<1.5*195<<" + "  //losos'
      <<53<<" + "       //shokolad
      <<0.6*14<<" + "   //pomidor
      <<0.6*47<<" + "   //jabloco
  ...
  */  
  /*
  cout<<1.0*93<<" + "      //tvorog solenyja
      <<2.0*68 <<" "     //tvorog jougurt
      <<endl;
  */
  /*
  cout<<1.9*133<<" + "  //lama
      <<1.0*91 <<" + "  //tvorog solenyja
      <<3.0*20 <<" + "  //tvorog solenyja
      <<0.7*350 <<" + "  //grechka
      <<0.03*828<<" + "  //olivkovoe maslo
      <<50<<"  "  //olivkovoe maslo
      <<endl;
...
*/
  ...
  */
  ...
  cout<<0.7*371<<" + "  //avsjanka
      ...
      <<endl;  
  */
  //cout<<(4.5/2.0*57 + 6.0/2.0*30 + 4.0*113 + 2.5/3.0*255)/4.0<<endl;  
  /*
  cout<<0.5*38<<" + "  //mandarin
      <<0.2*216<<" + "  //varenie
      <<1.0*97<<" + " //quark
      <<221<<" + " //sup 
      ...
      <<0.3*325<<" + " //Gorgonzolla
      <<1.0*1.8*43<<" + " //apelsin
      <<5.0/3.0/2.0*173<<"  " //govjadina
      <<endl;
  */
  /*
  cout<<1.0*159<<" + "  //serdce kurinoe
      <<0.75*27<<" + "  //shampinjony
      <<0.75*24<<" + "  //kabachok
      <<0.6*157<<" + "  //jajco
      <<0.7*14<<" + " //pomidor
  ...
  */
  ...
  cout<<120/2.0<<" + "  // blin
      <<0.26*181<<" + " //varenie
      <<0.3*111<<" + "  //krasnaja ryba
      <<0.5*48<<" + "  //moloko
      <<1.9*66<<"  " //jogurt
      <<endl;
  */
  /*
  cout<<1.5*130<<" + "  // vyrezka
      <<0.65*352<<" + " //chichevica
      <<4.0*30<<" + "  //salat
      <<1.25/2.0*165<<" + "//mocarella
      <<46<<" + " //moloko
      <<120<<" + "  //blin
      <<0.3*181<<" + " //varenie
      <<1.0*150<<" + " //tvorog
  ...
  */
  ...
  cout<<1.5*60<<" + " //mango
      ...
      <<endl;  
  */
  //cout<<(0.2*391 + 2.3*326 + 1.0*346 + 1.2*157 + 10.0*47 + 0.32*398 + 0.1*828)/16<<endl; //bliny
  /*
  cout<<1.5*130<<" + " //blin
      <<1.5*130<<" + "  // vyrezka
      <<0.7*343<<" + "  //grechka 
  ...
  */
  //tort
  /*
  cout<<4.0*331<<" + "  //zgushenka
      <<2.3*347<<" + "  //muka
      <<1.8*157<<" + "  //jajco
      <<0.5*391<<" + "  //kakao
      <<2.5*47<<" + "   //moloko
      <<2.0*400<<" + "  //sahar
      <<1.5*400<<" + "  //saharnaja pudra
      <<1.5*771<<" "    //slivochnoe maslo
      <<endl;  
  */
  /*
  cout<<0.5*130<<" + "  //blin
  ...
  */
  ...
  cout<<2.0*400<<" + " // gus
      ...
      <<2.0*77<<" + " //  kartofel
      <<2.0*170<<" + " //    salat olive
      <<1.0*130<<" + " //    salat vinigret
      <<4*1.8*50<<" + "  //apesiny_mandarin
      <<4*100<<"  "  // pichenki
      <<endl;
  */
  /*
 ...
 */   
  ...
  */
  ...
  cout<<2.0*180<<" + " //losos
	<<3.0*30<<" + "  //salat
	<<1.0*0.58*204<<" + " //HLEB
	<<1.5/2.0*1.1*162<<" + " //sur162
	<<0.3*152<<" + "  //varenie
	<<0.6*121<<" + "  //varenie
	<<1.0*180<<" + "  //sur180
      	<<0.5*132<<" "  //zgushenka132
	<<endl;
  */
  /*
  cout<<0.3*121<<" + "  //varenie121
      <<0.2*132<<" + "  //zgushenka132
      <<1.0*46<<" + "   //sur46
      <<1.0*72<<" + "   //sur72
      <<0.5*180<<" + "  //sur180
      <<0.4*270<<" + "  //syrki
  ...
  */
  ...
  cout<<2*52<<" + "     //syr
      ...
      <<1.2*157<<" + "  //jajco
      <<1.2*14<<" + "   //pomidor
      <<0.03*900<<" + "   //olivkovoe maslo
      <<0.05*744<<" "   //maslo
      <<endl;
  */
  cout<<1.5*350<<" + " //makarony
      <<0.5*443<<" + " //pesto
      <<0.2*400<<" + " //parmizan
      <<1.5*120<<" + " //mjaso
      <<26<<" + "  //sparja
